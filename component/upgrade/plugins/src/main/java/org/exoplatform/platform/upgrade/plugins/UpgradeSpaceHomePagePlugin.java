...
public class UpgradeSpaceHomePagePlugin extends UpgradeProductPlugin {
    ...
    private static final String SPACE_NEW_HOME_PAGE_TEMPLATE = "space";
    ...
    public   UpgradeSpaceHomePagePlugin (DataStorage dataStorageService, OrganizationService organizationService,SpaceStorage spaceStorage, SpaceService spaceService, UserPortalConfigService userPortalConfigService, PageService pageService, InitParams initParams) {
        super(initParams);
    ...
    private void editSpaceHomePage(String spacePrettyName, String spaceGroupId) {
        ...
        try {
            ...
            Page oldSpaceHomePage = dataStorageService.getPage(PortalConfig.GROUP_TYPE + "::" + spaceGroupId + "::" + spaceService.getSpaceApplicationConfigPlugin().getHomeApplication().getPortletName());
