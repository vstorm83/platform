...
WAIPortalToolbar.prototype.changeOveralTheme = function(newTheme) {
  ...
  if (newTheme=="SkinMono") {
    ...
    document.getElementById("WAIPortalFontSizeSmallImg").setAttribute("src", "/platform-extension/skin/resources/WhiteSmallIcon.png");
    document.getElementById("WAIPortalFontSizeMediumImg").setAttribute("src", "/platform-extension/skin/resources/WhiteMediumIcon.png");
    document.getElementById("WAIPortalFontSizeLargeImg").setAttribute("src", "/platform-extension/skin/resources/WhiteLargeIcon.png");
    ...
    document.getElementById("WAIPortalFontSizeSmallImg").setAttribute("src", "/platform-extension/skin/resources/BlackSmallIcon.png");
    document.getElementById("WAIPortalFontSizeMediumImg").setAttribute("src", "/platform-extension/skin/resources/BlackMediumIcon.png");
    document.getElementById("WAIPortalFontSizeLargeImg").setAttribute("src", "/platform-extension/skin/resources/BlackLargeIcon.png");
